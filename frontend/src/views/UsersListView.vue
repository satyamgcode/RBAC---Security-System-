            ...
            <div class="space-y-4">
                <div v-for="user in users" :key="user._id" class="flex justify-between items-center py-2 border-b">
                    ...
                    <div class="flex space-x-2">
                        <router-link :to="`/users/${user._id}`" v-if="canEdit" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">Edit</router-link>
                        <button @click="handleDelete(user._id)" v-if="canDelete"
