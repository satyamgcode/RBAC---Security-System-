...
userRoutes.get('/', authMiddleware, permissionMiddleware(['read', 'edit', 'delete'], true), [
...
userRoutes.get('/:id', authMiddleware, permissionMiddleware(['read', 'edit', 'delete'], true), [
...
userRoutes.put('/:id', authMiddleware, [
    param('id').isMongoId().withMessage('Invalid user ID format'),
    body('role').optional().isIn(['admin', 'user', 'moderator']).withMessage('Role must be "admin" or "user"'),
...
userRoutes.delete('/:id', authMiddleware, permissionMiddleware('delete', true), [
    param('id').isMongoId().withMessage('Invalid user ID format')
